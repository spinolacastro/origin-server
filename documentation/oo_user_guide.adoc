...
O próximo passo do processo de instalação consiste em criar e fazer o upload de uma chave SSH para o broker. Isso é necessário para realizar push do código fonte, através do Git, para o OpenShift Origin server.
